  ...
  if (!isAuthenticated) {
    return (
      <div className={className}>
        <Link href="/login" className="-m-2.5 flex cursor-pointer items-center justify-center rounded-full p-2.5 hover:bg-neutral-100 focus-visible:outline-hidden dark:hover:bg-neutral-800">
